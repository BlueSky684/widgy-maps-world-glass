...
export default async function handler(req,res) {
  ...
  try {
    ...
    const revision=['113','115','116','119','120','121','122','124','125'].includes(requested)?requested:'114';
    const renderer=revision==='125'?renderV125:revision==='124'?renderV124:revision==='122'?renderV122:revision==='121'?renderHomeMap:revision==='120'?renderV120:revision==='119'?renderV119:revision==='116'?renderV116:revision==='115'?renderV115:revision==='113'?renderV113:renderV114;
